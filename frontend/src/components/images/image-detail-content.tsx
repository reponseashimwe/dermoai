  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
              ...
              <>
                <Button
                  ...
                  className={cn(
                    ...
                    !showGradCAM && "bg-white text-primary-600 shadow-sm hover:bg-white hover:text-primary-700"
                  )}
                >
        ...
        {showGradCAM && image.gradcam_metrics && explainabilityMetrics !== "hidden" && (
      ...
      <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-6 sm:gap-8">
              <div className="flex items-center gap-5 sm:gap-6">
                ...
                <div>
                  ...
                  <UrgencyBadge urgency={urgency} size="sm" className="mt-1" />
                </div>
              </div>
            </div>
          ) : (
          ...
          <details className="group rounded-lg border border-slate-200 bg-slate-50/50">
            ...
            <div className="border-t border-slate-200 px-5 pb-5 pt-2">
              <p className="text-sm text-slate-700 leading-relaxed">
                {conditionInfo.recommendedAction}
              </p>
            </div>
          </details>
        )}
        ...
        {showActionButtons && (
          <div className="flex flex-wrap gap-3 pt-2">
            {onReferSpecialist && (
              <Button variant="outline" size="sm" onClick={onReferSpecialist}>
