...
const iconBoxClass = "bg-primary-600 text-white";
...
const cardContentClass = (compact: boolean) =>
  compact
    ...
    : "flex items-center gap-3 py-5 px-4 sm:py-6 sm:px-5";
...
const innerContent = (
  ...
  <>
    ...
    <div className="min-w-0 flex-1">
      <p className={compact ? "text-xl font-bold text-slate-900 sm:text-2xl" : "text-lg font-bold text-slate-900 sm:text-xl"}>
        {value}
      </p>
