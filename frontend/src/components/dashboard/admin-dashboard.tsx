                      ...
                      a 15.9155 15.9155 0 0 1 0 -31.831'
						...
						<div className='space-y-2.5 text-sm'>
							{[
								{
									label: "Low (<40%)",
									value: s.model_stats.confidence_distribution.low,
									color: "bg-slate-400",
								},
								{
									label: "Medium (40–60%)",
								...
								{
									label: "Good (60–80%)",
									value: s.model_stats.confidence_distribution.good,
									color: "bg-blue-500",
								},
								{
									label: "High (>80%)",
								...
								return (
									...
									>
										...
										<div className='flex items-center gap-2'>
											...
											<span className='w-6 text-right font-medium text-slate-900'>
												{bin.value}
											</span>
										</div>
									</div>
			...
			<div className='grid gap-5 sm:grid-cols-2 lg:grid-cols-3'>
				...
				<Card className='border border-slate-200'>
					<CardHeader>
						...
						<p className='text-sm text-slate-500'>Usage and appointment status</p>
					</CardHeader>
					<CardContent>
						...
						{s.telemed_stats.appointment_status && (
							<div className='mt-6 space-y-3 border-t border-slate-200 pt-6'>
								{[
									{
										key: "pending",
										label: "Pending",
										value: s.telemed_stats.appointment_status.pending,
										color: "bg-amber-500",
									},
									{
										key: "approved",
										label: "Approved",
										value: s.telemed_stats.appointment_status.approved,
										color: "bg-blue-500",
									},
									{
										key: "rescheduled",
										label: "Rescheduled",
										value: s.telemed_stats.appointment_status.rescheduled,
										color: "bg-violet-500",
									},
									{
										key: "completed",
										label: "Completed",
										value: s.telemed_stats.appointment_status.completed,
										color: "bg-emerald-600",
									},
									{
										key: "rejected",
										label: "Rejected",
										value: s.telemed_stats.appointment_status.rejected,
										color: "bg-red-500",
									},
								].map((status) => (
									<div
										...
										<div className='flex items-center gap-3'>
											<div className='h-2 w-32 rounded-full bg-slate-100'>
												<div
													...
													style={{
														width: `${
															s.telemed_stats.appointments_total > 0
																? (
																		(status.value /
																			s.telemed_stats.appointments_total) *
																		100
																	).toFixed(0)
																: 0
														}%`,
											...
											<span className='w-8 text-right text-base tabular-nums font-bold text-slate-900'>
												{status.value}
											</span>
										</div>
									</div>
