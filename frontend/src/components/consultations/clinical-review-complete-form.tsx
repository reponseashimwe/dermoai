...
export function ClinicalReviewCompleteForm({
		...
		>
			<div className='grid gap-6 md:grid-cols-[1fr_1fr]'>
				...
				<div className='space-y-5 rounded-xl border border-slate-200 bg-white p-5'>
					<h3 className='text-base font-semibold text-slate-900'>1. Clinical Assessment</h3>
				...
				{/* Right column: Disposition + Outcome */}
				<div className='space-y-5'>
					...
					<div className='space-y-3 rounded-xl border border-slate-200 bg-white p-5'>
						<h3 className='text-sm font-semibold text-slate-900'>3. Treatment Outcome</h3>
						<label className='flex cursor-pointer items-center gap-2'>
							...
							/>
							<span className='text-sm text-slate-700'>Patient received treatment</span>
						</label>
						<label className='flex cursor-pointer items-center gap-2'>
							<input
								type='checkbox'
							...
							/>
							<span className='text-sm text-slate-700'>Outcome verified (follow-up completed)</span>
						</label>
					</div>
				</div>
			</div>
			...
			{/* Section 4: Finalize */}
			<div className='space-y-4 rounded-xl border border-primary-200 bg-primary-50/40 p-5'>
				<h3 className='text-sm font-semibold text-slate-900'>4. Finalize Review</h3>
				{canMarkFinal && (
	...
	return (
		<Card>
			<CardHeader>
				<h2 className='text-lg font-semibold text-slate-900'>Complete Clinical Review</h2>
