		...
		<>
			<div className='grid gap-4 grid-cols-1'>
				{scans.map((scan) => {
					...
					const urgency = scan.urgency ?? "REFER";
					return (
						<Card
							key={scan.image_id}
							...
							<CardContent className='p-4'>
								<div className='flex gap-4'>
									...
									<div className='flex-1 min-w-0'>
										...
										<p className='text-xs text-slate-400 mt-0.5'>{formatDate(scan.uploaded_at)}</p>
										<label
											className={cn(
										...
										>
											...
											<span
												...
												className={cn(
													...
													scan.consent_to_reuse ? "bg-primary-600" : "bg-slate-200",
												)}
											>
												<span
													className={cn(
											...
											<span className='text-slate-600'>
												Consent for reuse in model improvement
											</span>
										</label>
										<div
