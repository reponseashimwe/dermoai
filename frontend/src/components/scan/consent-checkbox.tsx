...
export function ConsentCheckbox({ checked, onChange, className }: ConsentCheckboxProps) {
	return (
		<label
			className={cn(
		...
		>
			...
			>
				I consent to my image being stored and potentially used for improving the AI model. My image will be
				anonymized and handled securely.
			</span>
		</label>
	);
}
